        ...
        <PartnersContainer>
            ...
            <div className='w-full flex justify-evenly'>
                <div className='flex flex-col items-center'>
                    ...
                    <img className='w-[20em] mt-10 cursor-pointer hover:scale-105 ease-in-out duration-300' src={sparkLife} onClick={goToSitePartner.bind(null, "https://www.sparklifesps.com/")} />
                </div>
                <div className='flex flex-col items-center'>
                    <PartnersTitle style={{ fontSize: '2em' }}>
                        Sponsor Silver
                    </PartnersTitle>
                    <img className='w-[20em] mt-10 cursor-pointer hover:scale-105 ease-in-out duration-300' src={ackaGames} onClick={goToSitePartner.bind(null, "https://ackagames.com/")} />
                </div>
            </div>
        </PartnersContainer>
    )
